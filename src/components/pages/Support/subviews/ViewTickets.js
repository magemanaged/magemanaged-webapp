...
function ViewTickets(props) {
  ...
  return (
    <div className={`view-tickets-view ${props.selected == props.name ? 'show' : 'hide'}`}>
        <div className="view-tickets-card page-view-card">
           <div className="header-container">
               ...
               <div className="tab-selection">
                <TabList items={views} click={setView} selected={selectView} style={"card-tab"} color={"reverse-color"}/>
            </div>
           </div>
        </div> 
    </div>
